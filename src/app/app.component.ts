...
onCreateConfirm(event:any):void { 
  if (window.confirm('Estás seguro de querer agregar un nuevo artículo?')) {
...
onUpdateConfirm(event:any):void {
  if (window.confirm('Estás seguro de actualizar este artículo?')) {
    event.confirm.resolve(event.newData);
